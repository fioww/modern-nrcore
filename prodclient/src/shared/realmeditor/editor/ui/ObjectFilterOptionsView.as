...
public class ObjectFilterOptionsView extends Sprite {
    ...
    private var arrowText:BaseSimpleText;
    ...
    public function ObjectFilterOptionsView(listView:MapDrawElementListView) {
        ...
        this.arrowText = new BaseSimpleText(20, 0xFFFFFF);
...
import shared.realmeditor.editor.ui.ObjectFilterOptionsView;
...
class FilterOption extends Sprite {
    ...
    private var propText:BaseSimpleText;
    private var valText:BaseSimpleText;
    private var cross:Sprite;

    public function FilterOption(propName:String, val:*) {
        this.propName = propName;

        this.propText = new BaseSimpleText(18, 0xFFFFFF);
        ...
        this.valText = new BaseSimpleText(18, 0xFFFFFF);
