...
public class DrawListTooltip extends Tooltip {
    ...
    private var idText:BaseSimpleText;
    private var properties:String = "";
    private var propertiesText:BaseSimpleText;
    ...
    private function drawElementId():void {
        this.id = this.xml.@id;
        this.idText = new BaseSimpleText(18, 0xFFFFFF);
    ...
    private function drawProperties():void {
        this.propertiesText = new BaseSimpleText(16, 0xB2B2B2);
