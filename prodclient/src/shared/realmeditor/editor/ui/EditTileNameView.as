...
import shared.realmeditor.editor.ui.elements.SimpleCloseButton;

import shared.realmeditor.editor.ui.elements.SimpleInputBox;
import shared.realmeditor.editor.ui.elements.SimpleOkButton;
...
public class EditTileNameView extends Sprite {
    ...
    private var title:BaseSimpleText;
    ...
    public function EditTileNameView(x:int, y:int, objName:String) {
        ...
        this.title = new BaseSimpleText(20, 0xFFFFFF);
        ...
        this.nameInput = new SimpleInputBox(WIDTH, 30, this.objName, 18, 0xFFFFFF);
