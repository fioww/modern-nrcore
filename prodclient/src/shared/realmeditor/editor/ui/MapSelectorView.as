...
import shared.realmeditor.editor.ui.MapSelectorView;
import shared.realmeditor.editor.ui.MapView;
import shared.realmeditor.editor.ui.elements.TextTooltip;
import shared.realmeditor.editor.ui.elements.BaseSimpleText;
...
class MapSelectorSlot extends Sprite {
    ...
    public function MapSelectorSlot(mapId:int, name:String){
        ...
        this.text = new BaseSimpleText(16, 0xFFFFFF, false, WIDTH - 10);
